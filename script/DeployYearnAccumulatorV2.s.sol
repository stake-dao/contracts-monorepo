...
contract DeployYearnAccumulatorV2 is Script, Test {
    ...
    address public constant DAO_FEE_RECIPIENT = 0xF930EBBd05eF8b25B1797b9b2109DDC9B0d43063;
    address public constant LIQUIDITY_FEE_RECIPIENT = 0xF930EBBd05eF8b25B1797b9b2109DDC9B0d43063;
    ...
    function run() public {
        ...
        accumulator =
            new YearnAccumulatorV2(sdYfiLG, yfiLocker, DAO_FEE_RECIPIENT, LIQUIDITY_FEE_RECIPIENT, YEARN_STRATEGY);
        vm.stopBroadcast();
    }
}
