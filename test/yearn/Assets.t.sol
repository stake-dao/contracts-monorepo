...
contract _YETH_Strategy is YearnStrategyTestBis(YETH_GAUGE) {}

address constant YFI_ETH_GAUGE = 0x7Fd8Af959B54A677a1D8F92265Bd0714274C56a3;

contract _YFI_ETH_Strategy is YearnStrategyTestBis(YFI_ETH_GAUGE) {}

address constant YCRV_GAUGE = 0x107717C98C8125A94D3d2Cc82b86a1b705f3A27C;

contract _YCRV_Strategy is YearnStrategyTestBis(YCRV_GAUGE) {}

address constant DYFI_ETH_GAUGE = 0x28da6dE3e804bDdF0aD237CFA6048f2930D0b4Dc;

contract _DYFI_ETH_Strategy is YearnStrategyTestBis(DYFI_ETH_GAUGE) {}
