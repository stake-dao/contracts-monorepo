...
/// @notice IFO Factory for the Cake IFO on Arbitrum
/// CHANGELOG:
/// - Interact with the executor instead of the locker
contract IFOFactory {
    ...
    constructor(address _locker, address _governance, address _feeReceiver) {
    ...
    {
        (success, result) = locker.execute(_addr, 0, _data);
    }
