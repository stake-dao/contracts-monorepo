...
abstract contract BaseAccumulatorTest is CommonBase, Test {
    ...
    function setUp() public virtual {
        ...
        /// Deploy AccumulatorBase Contract.
        ...
        vm.prank(AccumulatorBase(accumulator).governance());
        AccumulatorBase(accumulator).setAccountant(mockAccountant);

        AccumulatorBase.Split[] memory splits = new AccumulatorBase.Split[](2);
        splits[0] = AccumulatorBase.Split(treasuryRecipient, 5e16);
        splits[1] = AccumulatorBase.Split(liquidityFeeRecipient, 10e16);
    ...
    function test_setup() public view virtual {
        ...
        AccumulatorBase.Split[] memory splits = accumulator.getFeeSplit();
    ...
    function test_setters() public {
        AccumulatorBase.Split[] memory splits = new AccumulatorBase.Split[](2);
        splits[0] = AccumulatorBase.Split(address(treasuryRecipient), 100);
        splits[1] = AccumulatorBase.Split(address(liquidityFeeRecipient), 50);
