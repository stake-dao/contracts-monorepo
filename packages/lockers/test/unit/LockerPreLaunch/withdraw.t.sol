...
contract PreLaunchLocker__withdraw is PreLaunchLockerTest {
        ...
        _cheat_replacePreLaunchLockerWithPreLaunchLockerHarness
    {
        ...
        LockerPreLaunch.STATE[2] memory states = [LockerPreLaunch.STATE.ACTIVE, LockerPreLaunch.STATE.IDLE];
        ...
        for (uint256 i; i < states.length; i++) {
            ...
            // expect the revert
            vm.expectRevert(LockerPreLaunch.CANNOT_WITHDRAW_IDLE_OR_ACTIVE_LOCKER.selector);
