...
import {DrippingAccumulatorHarness} from "test/unit/AccumulatorDripping/utils/DrippingAccumulatorHarness.sol";
...
contract DrippingAccumulator__constructor is Test {
    function test_SetsThePeriodLength(uint256 _periodLength) external {
        ...
        AccumulatorDripping drippingAccumulator = new DrippingAccumulatorHarness(
