...
contract BaseAccumulator__chargeFee is BaseAccumulatorTest {
    ...
    function setUp() public virtual override {
        ...
        splits[0] = BaseAccumulator.Split({receiver: makeAddr("receiver1"), fee: 1e17});
        splits[1] = BaseAccumulator.Split({receiver: makeAddr("receiver2"), fee: 5e17});
    ...
    function _calculateExpectedChargedFee(uint256 amount) internal view returns (uint256 expectedChargedFee) {
        BaseAccumulator.Split[] memory splits = baseAccumulator.getFeeSplit();
