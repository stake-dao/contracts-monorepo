...
interface IDefiEdgeStrategy {
     ...
     */
    function mint(uint256 _amount0, uint256 _amount1, uint256 _amount0Min, uint256 _amount1Min, uint256 _minShare)
        external
    ...
    function getAUMWithFees(bool _includeFee)
        external
        view
        returns (uint256 amount0, uint256 amount1, uint256 totalFee0, uint256 totalFee1);
