...
contract AngleMerklClaimer {
    ...
    IAngleMerkleDistributor public merkleDistributor =
        IAngleMerkleDistributor(0x3Ef3D8bA38EBe18DB133cEc108f4D14CE00Dd9Ae);
    ...
    constructor(address _governance, address _daoRecipient, address _accRecipient, address _veSdtFeeRecipient) {
    ...
    function claimAndNotify(bytes32[][] calldata _proofs, address _vault, address _token, uint256 _amount) external {
